...
function wingsAnimation() {
	
	var wingPart1 = spaceship.model.getObjectByName("Line53_bluehull");
	var wingPart2 = spaceship.model.getObjectByName("Line60_solar");
	var wingPart3 = spaceship.model.getObjectByName("Spot03_bluehull");

	wingPart1.rotation.y += spaceship.rotationStep;
	wingPart2.rotation.y += spaceship.rotationStep;
	wingPart3.rotation.y += spaceship.rotationStep;
